...
class MenuItems extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['file_id', 'sort', 'menu_id_parent_id', 'deleted_at', 'menu_items'], 'default', 'value' => null],
            [['url'], 'default', 'value' => '#'],
            ...
            [['title', 'menu_items'], 'safe'],
            [['url'], 'string', 'max' => 255],
            [['file_id'], 'exist', 'skipOnError' => true, 'targetClass' => File::class, 'targetAttribute' => ['file_id' => 'id']],
            [['menu_id'], 'exist', 'skipOnError' => true, 'targetClass' => Menus::class, 'targetAttribute' => ['menu_id' => 'id']],
            [['menu_id_parent_id'], 'exist', 'skipOnError' => true, 'targetClass' => MenuItems::class, 'targetAttribute' => ['menu_id_parent_id' => 'menu_id']],
        ];
    }
    ...
    {
        return $this->hasOne(MenuItems::class, ['menu_id' => 'menu_id_parent_id']);
    }
    ...
    {
        return $this->hasMany(MenuItems::class, ['menu_id_parent_id' => 'menu_id']);
    }
