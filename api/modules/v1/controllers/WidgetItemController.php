 ...
 */
class WidgetItemController extends ApiController
{
    public $data = 'widgetItem';
    ...
    public function actionCreate()
    {
        ...
        if ($this->request->isPost) {
            if ($model->load($this->request->post(), '') && $model->validate()) {
                ...
                if ($model->uploadFile() && $model->save(false)) {
                    return [
                        'success' => 'Created "WidgetItem" successfully',
                        'data' => $model,
                    ];
                }
            }
        ...
        return [
            'success' => 'Error creating "WidgetItem"',
            'errors' => $model->errors,
        ];
    }
    ...
    public function actionUpdate($id)
    {
        ...
        if ($this->request->isPost || $this->request->isPatch) {
            if ($model->load($this->request->post(), '') && $model->validate()) {
                ...
                if ($model->save(false)) {
                    return [
                        'success' => true,
                        'message' => 'Update "WidgetItem" successfully',
                        'data' => $model,
                    ];
                }
            }
        ...
        return [
            'success' => false,
            'message' => 'Error updating "WidgetItem"',
            'errors' => $model->errors,
        ];
    }
    ...
    function findModel($id)
    {
        ...
        throw new NotFoundHttpException('The requested widgetItem.id does not exist.');
    }
}
